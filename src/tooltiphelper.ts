...
export class StatusHeatmapTooltipHelper {
    scope: any;
    dashboard: any;
    panelCtrl: any;
    panel: any;
    ...
    constructor(elem: any, scope: any) {
        ...
        public add() {
            this.tooltip = d3.select("body")
              .append("div")
              .attr("class", "statusmap-tooltiphelper graph-tooltip grafana-tooltip");
        }
        ...
        public show(pos: any) {
            ...
            if (this.panel.color.mode === 'discrete') {
                if (card.noColorDefined) {
                    let badValues: any = this.panelCtrl.discreteHelper.getNotColoredValues(values);
